...
use App\Mail\WaterIntakeReminderMail;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Log;
use App\Models\User;

class SendWaterIntakeReminder extends Command
{
    // The name and signature of the console command.
    protected $signature = 'reminder:water-intake';
    ...
    public function handle()
    {
        try {
            ...
            foreach ($users as $user) {
                ...
                Mail::to($user->email)->send(new WaterIntakeReminderMail($msg, $sub));
